     ...
     db.query(usernameQuery, (err, result) => {      
         ...
         if (result.length > 0) { 
          ...
          db.query(Query1, (err1, result1) => {      
              ...
              let Query5 ="INSERT INTO `wp_transaction` SET `order_item_name`='"+OrderItem+"',balance_hours='"+BalHours+"',total_hours='"+TotalHours+"' where user_id='"+userid+"'";
              db.query(Query5, () => {   });  
 
              let Query6 ="INSERT INTO `wp_hours` SET `order_item_name`='"+OrderItem+"',balance_hours='"+BalHours+"',total_hours='"+TotalHours+"' where user_id='"+userid+"'"; 
              db.query(Query6, () => {   }); 
